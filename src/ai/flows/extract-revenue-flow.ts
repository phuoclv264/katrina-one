...
const ExtractRevenueOutputSchema = z.object({
    ...
    reportTimestamp: z.string().optional().describe('The date and time the report was generated, usually labeled "Ngày giờ". You MUST extract it exactly as seen and return it in "YYYY-MM-DD HH:mm:ss" format. This is the most critical field.'),
...
1.  **reportTimestamp**: This is the MOST IMPORTANT field. Find the report's generation date and time. Look for a label like "Ngày giờ". You MUST return it as a string in "YYYY-MM-DD HH:mm:ss" format. If you cannot find this field or it's unreadable, you MUST return null for this field. This is absolutely critical.
