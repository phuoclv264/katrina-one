...
const SortTasksOutputSchema = z.object({
  sortedTasks: z.array(z.string()).describe('The array of task descriptions, sorted in a logical order.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert restaurant operations manager. Your task is to sort a given list of tasks into a logical and efficient order based on the provided context.

Do not add, remove, or modify any tasks. Return the exact same tasks in the 'sortedTasks' array, just in a more logical sequence.
