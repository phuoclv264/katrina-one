...
import { ArrowLeft, ChevronLeft, ChevronRight, UserCheck, RefreshCw, Loader2, DollarSign, LayoutGrid, GanttChartSquare, X, Calendar as CalendarIcon } from 'lucide-react';
...
import ManualAttendanceDialog from './_components/manual-attendance-dialog';
...
import AttendanceTimeline from './_components/attendance-timeline';
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pt-4 border-t">
                            ...
                            <div className="flex items-center gap-2">
                                <Button variant={viewMode === 'table' ? 'secondary' : 'outline'} onClick={() => setViewMode('table')}><LayoutGrid className="mr-2 h-4 w-4" /> Bảng</Button>
                                <Button variant={viewMode === 'timeline' ? 'secondary' : 'outline'} onClick={() => setViewMode('timeline')}><GanttChartSquare className="mr-2 h-4 w-4" /> Dòng thời gian</Button>
                            </div>
                        </div>
                    </CardContent>
                </Card>
