...
function EditItemPopover({ item, onSave, children, inventoryItem, dialogRef }: { item: ExpenseItem; onSave: (updatedItem: ExpenseItem) => void; children: React.ReactNode, inventoryItem: InventoryItem | undefined, dialogRef?: React.RefObject<HTMLDivElement | null> | React.MutableRefObject<HTMLDivElement | null> }) {
                            ...
                            {expenseType === 'goods_import' ? (
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <Combobox
                                            value={otherCostCategoryId}
                                            onChange={setOtherCostCategoryId}
                                            options={otherCostCategories.map(cat => ({ value: cat.id, label: cat.name }))}
