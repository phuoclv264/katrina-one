...
type OwnerExpenseSlipDialogProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    ...
    return (
        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                 ...
                                 <div className="space-y-2">
                                    ...
                                    <Input value={slipToEdit?.createdBy?.userName || ''} disabled className="bg-muted"/>
                                </div>
                            </div>

                            <Card className={cn('transition-all', showMissingAttachmentAlert && 'border-destructive ring-2 ring-destructive/50 bg-destructive/5')} ref={attachmentCardRef}>
                                <CardHeader className="pb-4">
                                    <CardTitle className="text-base text-primary">Ảnh đính kèm</CardTitle>
            ...
            <Lightbox
                ...
                carousel={{ finite: true }}
                counter={{ container: { style: { top: "unset", bottom: 0 } } }}
                portal={{ root: document.getElementById("owner-expense-slip-lightbox-container") ?? undefined }}
            />
        </>
    );
}
